...
-- Copiando estrutura para tabela 2dsb.funcioranio
CREATE TABLE IF NOT EXISTS `funcioranio` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `nome` varchar(100) DEFAULT NULL,
...
-- Copiando dados para a tabela 2dsb.funcioranio: ~0 rows (aproximadamente)
DELETE FROM `funcioranio`;
